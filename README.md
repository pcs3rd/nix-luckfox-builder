...
# Claude To-Do. 
 ...
 - Draft/propose a more minimal alternative to meshing-around. We only really need _basic_ bbs and store & foward services for now. I don't know C, but it's ok if we start in python, then convert to C later. This will be in the mesh-bbs folder. This is also seperate from, and not explicitly based on meshing-around
