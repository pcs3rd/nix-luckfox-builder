...
{
  # ox64-sdimage.nix is the sole setter of this option — no default in
  # options.nix (readOnly options count the default as a definition too,
  # so having both a default and a config assignment causes a conflict).
